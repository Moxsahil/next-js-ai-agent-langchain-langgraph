...
export default function DashboardPage() {
  ...
  const username = isLoaded
    ...
    : "loading...";
  return (
    <div className="bg-[#262624] min-h-screen">
      <div className="flex items-center justify-center p-3">
        <div className="relative max-w-2xl w-full">
          {/* Decorative elements */}
          <div className="absolute inset-0 -z-10 bg-gradient-to-r from-gray-100 to-gray-50/50 rounded-3xl"></div>
          <div className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#f5f5f5,1px,transparent_1px),linear-gradient(to_bottom,#f5f5f5,1px,transparent_1px)] bg-[size:4rem_4rem] rounded-3xl"></div>
          ...
          <div className="relative space-y-6 p-8 text-center">
            <div className="bg-white/60 backdrop-blur-sm shadow-sm ring-1 ring-gray-200/50 rounded-2xl p-6 space-y-4">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                ...
                sidebar. Your AI assistant is ready to assist you with any task.
              </p>
